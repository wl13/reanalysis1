...
#mutation_essentiality<-gene_data[essentiality!="" ,.(mutations=sum(`Monroe CDS SNM Count`), length=sum(`Local CDS length`)), by=.(essentiality)]
#mutation_essentiality<-gene_data[essentiality!="" ,.(mutations=sum(`Monroe intron SNM Count`), length=sum(`Local Intron length`)), by=.(essentiality)]
#mutation_essentiality<-gene_data[essentiality!="" ,.(mutations=sum(`Weng CDS SNM Count`), length=sum(`Local CDS length`)), by=.(essentiality)]
#mutation_essentiality<-gene_data[essentiality!="" ,.(mutations=sum(`Weng intron SNM Count`), length=sum(`Local Intron length`)), by=.(essentiality)]
